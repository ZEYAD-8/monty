...
|:-----:|--------------------:|--------------------|
|  1.   |   file_control.c  |    contains the required functions to tokenize the file    |
|  2.   |	 main.c  |	main function to navigate the program in execution		|
|  3.   |	 monty.h	|	 the header file  |
|  4.   |	 stack_control_1.c	|	 opcodes: push, pall, pint,	pop, swap  |
|  5.   |	 stack_control_2.c	|	 opcodes:	add, nop, sub, div, mul  |
|  6.   |	 stack_control_3.c	|	 opcodes: mod, pchar, pstr, rotl, rotr  |
|  7.   |	 free_control.c	|	 contains the necessary functions to free any memory and exit  |
...
[Zeyad Osama](https://github.com/ZEYAD-8) || [Marwa Ashraf](https://github.com/MarwaAshraf1812)
